...
# Inventory Store with SQLAlchemy in Python
...
```
git clone https://github.com/gutiluis/SQLAlchemy-Inventory.git
python -m venv env
...
* **GitHub Discussions:** [Open a discussion](https://github.com/gutiluis/SQLAlchemy-Inventory/discussions)
